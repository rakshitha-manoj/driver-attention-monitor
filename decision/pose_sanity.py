def is_plausible(pitch, yaw, roll, max_pitch=70.0, max_yaw=120.0, max_roll=60.0):
    """
    ...
    approach ~90 deg yaw, and camera mounting offset can add to this) --
    the goal is filtering garbage, not restricting normal head movement.
    """
