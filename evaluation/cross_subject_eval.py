...
def run_cross_subject():
    ...
    feature_cols = ["EAR", "MAR"]  # extend once head pose is real
    ...
    for name, clf in [
        ("svm_cross_subject", SVC(kernel="rbf", probability=True, random_state=42)),
        ("mlp_cross_subject", MLPClassifier(hidden_layer_sizes=(32, 16), max_iter=500, random_state=42)),
    ]:
    ...
    print(f"\nSame-subject SVM accuracy: {same_acc:.4f}")
